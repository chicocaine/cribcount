        ...
        <div>
                        ...
                        <div class="flex">
                            <div class="flex shrink-0 items-center">
                                <Link :href="route('home')">
                                    <ApplicationLogo class="block h-9 w-auto fill-[#F97316] text-zinc-800 dark:text-zinc-200" />
                                </Link>
                            </div>
            ...
            <div v-if="showingNavigationDropdown" class="sm:hidden bg-white dark:bg-zinc-950">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <div v-else class="pt-2 pb-3 border-t border-zinc-200 dark:border-zinc-800 flex">
                        <div class="ms-4 self-center">
                            <ThemeToggle />
                        </div>
